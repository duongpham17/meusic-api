...
exports.authTemplate = (des, url, code) => `
<html>
    <body>
        <table style="width: 100%;border-spacing: 0px;background: white;">
            ...
            <tr class="link">
                <td style="text-align: center">
                    <a class="link" href="${websiteLink}/#${url}" style="text-decoration: none; color: black; border:2px solid grey; box-shadow:0 1px 10px -3px lightgrey; padding: 1rem 3rem; border-radius: 10px; display:block; width: 100px; margin: 1rem auto"> 
...
exports.requestEmailChangeTemplate = (code) => `
<html>
    <body>
        <table style="width: 100%;border-spacing: 0px;background: white;">
